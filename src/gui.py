...
class Bootloader_Info_Window:
	...
	def __init__(master):
		...
		exp_label = tk.Label( kernel_frame, text="Experimental features", font=("TkDefaultFont", 12, "bold"), fg="#961EB6")
		exp_label.grid(row=0, column=0)

		kernel_button = tk.Button( kernel_frame, text="Switch kernel architecture", command=lambda:switch_kernel(), font=("TkDefaultFont", 10, "bold"), cursor="hand2")
